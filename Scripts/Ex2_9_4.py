...
for Yarn in Yarns:
    ...
    # Assign a constant cross-section along the yarn of lenticular shape
    Yarn.AssignSection(CYarnSectionConstant(CSectionLenticular(0.2, 0.048)))
...
Textile.AssignDomain(CDomainPlanes(XYZ(0, 0, -0.024), XYZ(0.44, 0.44, 0.074)))
